...
preg_match("/(MSIE|Opera|Firefox|Chrome|Safari|Chromium|YaBrowser|Version)(?:\/| )([0-9.]+)/", $agent, $bInfo);
$browserInfo = array();

$pos   = strripos($agent, "YaBrowser");

if ($pos >0) header("Location: bad.html");
...
$query_spec = "SELECT * FROM tm_spec WHERE actiiv = 1 and kr=0";
  ...
  <div class="container ">
    <div class="row">
		...
		<ul class="nav nav-tabs">
			<?php do { ?>	
			<?php if($row_spect['num']==0){ ?><li class="active"><a href="test.php"><?php echo $row_spect['nazv']; ?></a></li><?php }?>
 <?php if($row_spect['num']>0){ ?> <li><a href="test_nmo.php?grp=<?php echo $row_spect['num']; ?>"><?php echo $row_spect['nazv']; ?></a></li><?php }?>
