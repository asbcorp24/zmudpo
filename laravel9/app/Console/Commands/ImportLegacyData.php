...
class ImportLegacyData extends Command {
 ...
 public function handle(): int {
   ...
   DB::connection('legacy')->table('tm_spec')->orderBy('num')->chunkById(200,function($rows){foreach($rows as $r){Program::updateOrCreate(['legacy_id'=>$r->num],['title'=>$r->nazv ?: 'Программа '.$r->num,'starts_at'=>$r->dat ?: null,'image'=>$r->img ?: null,'is_active'=>(bool)$r->actiiv,'mode'=>isset($r->kr)&&((int)$r->kr!==0)?'nmo':'dpo']);}},'num');
