...
return new class extends Migration {
 ...
 public function down(): void {
  Schema::table('quizzes',fn(Blueprint $t)=>$t->dropColumn(['legacy_path','legacy_answer_file','legacy_image','legacy_question_count','legacy_date','import_status','import_message']));
 }
};
