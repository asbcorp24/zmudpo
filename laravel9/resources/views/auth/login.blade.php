 ...
 <div class="container">
  ...
  <div class="login-grid">
   <section class="program-picker">
    ...
    <p class="text-secondary mb-0">Сначала выберите специальность или цикл, затем найдите свою фамилию в списке группы.</p>
    ...
    <form method="post" action="{{ route('login.perform') }}">@csrf
     @if($selectedProgram)
      ...
      <div class="mb-3">
       ...
       <select name="login" id="studentSelect" class="form-select form-select-lg" required>
