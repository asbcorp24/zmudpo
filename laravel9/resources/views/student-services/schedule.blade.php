...
@php($usedByStudent=(int)($userCounts[$assignment->id]??0))
@php($limitReached=$assignment->sessions_per_student && $usedByStudent >= $assignment->sessions_per_student)
<div class="panel">
 ...
 @if($assignment->sessions_per_student)<p><strong>Ваши занятия:</strong> {{ $usedByStudent }}/{{ $assignment->sessions_per_student }}</p>@endif
 ...
 @elseif($limitReached)<span class="status blocked">Лимит занятий исчерпан</span>
